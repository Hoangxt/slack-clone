...
export const Profile = ({ memberId, onCloseProfile }: ProfileProps) => {
    ...
    return (
      <div className='h-full flex flex-col'>
        <div className='h-[49px] flex justify-between items-center px-4 border-b'>
          ...
          <Button onClick={onCloseProfile} size='iconSm' variant='ghost'>
    ...
    <div className='h-full flex flex-col'>
      ...
      <div className='flex flex-col p-4'>
        ...
        <div className='flex items-center gap-2'>
          <div className='flex items-center rounded-md justify-center bg-muted'>
